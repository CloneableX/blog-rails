...
class CatalogsControllerTest < ActionController::TestCase
  ...
  test "should destroy failed when articles about destroyed catalog present" do
    delete :destroy, id: articles(:one).catalog
    assert_equal 'Articles present!', flash[:notice]
  end
end
